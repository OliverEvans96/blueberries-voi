...
| Belief accuracy table (mean-f MAE, freshness W₁, count MAE) | `data-belief-mae-table`, `currentFreshnessW1`, `meanFreshnessW1OverHistory`, `countMeanAbsError`, `meanCountMaeOverHistory` | `web/src/react/StudioLayout.tsx:331`, `web/src/charts/beliefAccuracy.ts:102`, `:222`, `:324` |
