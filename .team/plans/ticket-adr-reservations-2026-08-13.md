...
| **CAL-01 calendar realism** | **T-076**–**T-088** | **0112**–**0116** | `team/T-076/architect` | Plan: [CAL-01-calendar-realism.md](./CAL-01-calendar-realism.md). Oliver reopened X-11 / MOD-09. |
| Landed on `main` (context) | …–T-066 | …–0104 | `main` | Highest ADR on `main` before CAL-01 = 0104 (+ readiness 0107–0108 may land separately). |

**Next free after CAL-01 claim:** tickets **T-089+**, ADRs **0117+**.
