...
| **Studio Autopilot Mode** | **T-091**, **T-097**–**T-101** | **0112** | `team/studio-autopilot/wave` @ `9a1d482` | Done pending human merge. Plan: [studio-autopilot.md](./studio-autopilot.md). User plan T-076–T-081 collided → these ids. Void draft T-092–T-096 / ADR 0111 for Autopilot. |
