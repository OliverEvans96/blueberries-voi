...
| **Studio Autopilot Mode** | **T-091**, **T-097**–**T-101** | **0117** | `team/studio-autopilot/wave` (merge tip `89088fa`) | Done pending human merge. Plan: [studio-autopilot.md](./studio-autopilot.md). Provisional Autopilot ADR 0112 → **0117** at CAL-01 merge. |
