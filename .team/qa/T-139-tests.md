...
|----|-----------|---------|--------|
| AC-1 | F3 in AC-12 drift guard | `lgtin_upc_homogeneous_fleet_count_bias_drift_guard` | `crates/voi_core/tests/lgtin_upc_ac12.rs` |
| AC-2 | F3 root-cause documented | `f3_dispersion_count_bias_root_cause_temperature_birth_center` | `lgtin_upc_ac12.rs` |
