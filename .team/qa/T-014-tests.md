...
- Same AC (ResearchParticleFilter age posterior + leakage) → `tests/test_lot_resolved_ll.py::test_sales_by_lot_update_targets_lot_a_more_than_lot_b_leakage_bound` — **PASS**
...
- One ResearchParticleFilter / one MC LL entrypoint → `tests/test_lot_resolved_ll.py::test_single_particle_filter_class_and_one_mc_ll_entrypoint` — **PASS**
