...
- **S2.5 — GSIN birth (three segments)** → `t163_multilot.rs::gsin_three_segments_per_delivery` + `unit_pf_ac.rs::gsin_multilot_delivery_segments_match_l` — currently failing: `push_lot_births` once → 1 segment, not 3
