...
- Stage B per Stage-A-pass rung + 90% CI / ranks + MD/figures under
  `figures/m2.5/` / `experiments/m25_stage_b_*.md`
  → `tests/test_stage_b_oracle.py::test_stage_b_rung_result_schema_fields`
  → `tests/test_stage_b_oracle.py::test_run_m25_stage_b_exported`
  → `tests/test_stage_b_oracle.py::test_run_m25_stage_b_accepts_rungs`
  → `tests/test_stage_b_oracle.py::test_run_m25_stage_b_accepts_shared_root_seed`
  → `tests/test_stage_b_oracle.py::test_run_m25_stage_b_accepts_stage_a_pass_map`
...
- Shared-CRN F2 ≪ P1 vs B-state gap table; B-clair out
  ...
  → `tests/test_stage_b_oracle.py::test_run_m25_oracle_ladder_exported`
  → `tests/test_stage_b_oracle.py::test_run_m25_oracle_ladder_shared_root_seed_and_compare_default`
...
- No CTL / VOI
  ...
  — currently failing: m25 / stage_b / oracle surface missing
...
- Stage C / M2.5 close-out — T-012 / T-018; LL/mask changes — out of scope
