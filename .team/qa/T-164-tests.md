...
| AC | Tests |
|----|-------|
| AC-protection-sim | `protection_sim::tests::bank_start_state_*` |
| AC-sla-mc | `protection_sim::tests::sla_mc_*` |
| AC-sla-pb | `protection_sim::tests::survival_index_*`, `sla_pb_stocked_shelf_*` |
