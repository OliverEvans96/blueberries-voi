...
- **Done — ENG-01 dual-runtime (T-042–T-058):** Slice 1–3 complete on the ENG-01 /
  Slice-3 close-out tip (`team/T-058/implement`; plan
  [ENG-01-dual-runtime.md](./plans/ENG-01-dual-runtime.md)). Pending human merge to
  `main` — agents did not merge to `main`. ADRs
