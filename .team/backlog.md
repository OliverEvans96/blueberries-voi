...
- **needs-human — T-115 studio show-truth toggle:** **Done / complete pending human merge.** Implement `team/T-115/implement` @ `4517eab`; review APPROVED `team/T-115/review` @ `0e8476f`; verify PASS `team/T-115/verify` @ `a6d4c35` (ADR [0122](./adr/0122-studio-show-truth-js-only.md)). Changelog and `.team/qa/T-115.md` live on the verify tip — merge implement + review + verify together. Agents must not merge to `main`. Keep `.worktrees/T-115-implement` until then.
