...
- **CAL-01 calendar realism:** **T-076–T-088**, ADR **0112–0116** — **Done / complete pending human merge.** Close-out tip: `team/T-088/integrate-main` (DoD [CAL-01.md](./reviews/CAL-01.md); plan [CAL-01-calendar-realism.md](./plans/CAL-01-calendar-realism.md); smoke [T-088.md](./qa/T-088.md); FIL-13 remotesure [CAL-01-fil13-remeasure-L.md](./reports/CAL-01-fil13-remeasure-L.md)). Agents did not merge to `main`. CAL-01 ADRs renumbered past ENG-01 0109–0111 on integrate tip.
- **Next free after CAL-01 claim:** **T-089+**, ADR **0117+**.
