...
- **Studio Autopilot Mode:** **T-091 + T-097–T-101**, ADR **0112** — **Done / complete pending human merge.** Tip ready: `team/studio-autopilot/wave` (verify @ `9a1d482`; includes post-handoff chore); plan [studio-autopilot.md](./plans/studio-autopilot.md); ADR [0112](./adr/0112-studio-autopilot-mode.md). User plan T-076–T-081 collided with CAL-01 → actual ids **T-091, T-097–T-101**; void first Autopilot draft that used T-092–T-096 / ADR 0111. Do **not** reuse T-076–T-081 for Autopilot.
...
- **needs-human — Studio Autopilot merge:** Human merge of `team/studio-autopilot/wave` (T-091 / T-097–T-101, ADR 0112; verify tip `9a1d482`) into parent when ready (agents must not merge to `main`). Keep implement worktrees until then.
