...
- **needs-human — Studio Autopilot merge:** Human merge of `team/studio-autopilot/wave` (T-091 / T-097–T-101, ADR 0117; merge tip `89088fa`) into parent when ready (agents must not merge to `main`). Keep implement worktrees until then.
