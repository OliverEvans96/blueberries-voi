...
- **Done — truth vs belief audit (T-115 / ADR 0125):** Landed on `main` (merge `3ddfd69`). Report [truth-vs-belief-audit.md](./reports/truth-vs-belief-audit.md). Optional polish: truth visual language, belief-grid axis gate, chip legend, `main.ts` integration test. ADR 0125 still `PROPOSED` — human accept when ready.
