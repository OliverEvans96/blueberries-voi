...
- **Done — truth vs belief audit (T-115 / ADR 0125):** Landed on `main`. Re-audit run 2: branch `audit/truth-vs-belief-2026-08-15` @ `558236e` (worktree `.worktrees/truth-belief-audit-2026-08-15`). Report [truth-vs-belief-audit.md](./reports/truth-vs-belief-audit.md). **Substantive remainder:** *Frontend knowledge-scenario UI audit* only. ADR 0125 still `PROPOSED`.
