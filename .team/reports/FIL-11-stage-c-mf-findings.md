...
**ADR:** [0086](../adr/0086-fil11-stage-c-sequential-wor-pmf-exact-vs-mf.md) (ACCEPTED — evidence machinery; does not flip ⚑ ADR 0049 / 0057)  
**Spec:** [T-008](../specs/T-008.md)  
...
**Verdict: PASS** against ADR 0086 freeze gates on P1 base + mild multi-day path.
...
Earlier soft `sales_pow` / `waste_pow` Gaussian stubs made “TV vs exact” **tautological** — the same soft likelihood drove both sides. ADR 0086 replaced that with a named density so Stage C can produce real FIL-04 evidence.
...
### 4.2 Base gates (ADR 0086 evaluation)
...
1. **Accept FIL-11 Stage C / FIL-04 evidence as PASS** under ADR 0086 gates.
...
| ADR (evidence lock) | `.team/adr/0086-fil11-stage-c-sequential-wor-pmf-exact-vs-mf.md` |
| Spec | `.team/specs/T-008.md` |
