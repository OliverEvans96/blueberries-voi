...
| ``notebooks/21_rust_controller_bakeoff.ipynb`` | ``controller_bakeoff`` × 40 | Oracle SIM-01=B; 10 seeds × 4 arms (constant, rung0, sw, sla_pb); no rollout/sla_mc; optional ``BELIEF_WORLD=filtered`` appendix |
